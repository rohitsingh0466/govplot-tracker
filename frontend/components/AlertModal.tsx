        ...
        <div className="w-full max-w-md bg-white rounded-[--r-2xl] overflow-hidden shadow-[--shadow-xl]">
          <div className="bg-gradient-to-br from-[--teal-700] to-[--teal-900] p-7 relative">
            ...
            <p className="text-[13px] text-[--teal-300]">
              {user ? "Manage alerts for your signed-in account." : "Sign in with Google first, then save alerts to your dashboard."}
            </p>
          </div>
          ...
          <div className="p-6">
            {!user ? (
              <div className="text-center py-4">
                ...
                <p className="text-[13.5px] text-[--ink-600] mb-6 leading-relaxed">
                  Free alerts now require an account so subscriptions stay linked to your dashboard. Continue with Google to subscribe.
                </p>
                <button
              ...
              <>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {channels.map(ch => (
                        ...
                        >
                          ...
                          {ch.badge && (
                            <span className="absolute -top-2 -right-2 text-[9px] bg-[--saffron-500] text-white px-1.5 py-0.5 rounded-full font-bold">{ch.badge}</span>
                          )}
                        </button>
                      ))}
                    </div>
                ...
                <p className="text-[11px] text-[--ink-400] text-center mt-3">
                  Free users can subscribe to email alerts. Telegram and WhatsApp unlock on Pro and Premium.
                </p>
              </>
            ) : (
