...
export default function AdminLayout({ children, title = "Admin" }: Props) {
  ...
  return (
    <>
      <Head>
        {/* Theme CSS variables injected globally so [data-theme] selectors work */}
        <style>{`
          :root, html[data-theme="dark"], html:not([data-theme="light"]) {
            ...
            --sec-title-color:rgba(255,255,255,0.5); --sec-link-color:#0f9e87; --sec-link-hover:#34d9bc;
          ...
          *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
          ...
          .admin-sidebar{
            ...
            z-index:200;box-shadow:2px 0 12px rgba(0,0,0,0.04)
          }
          .admin-root.collapsed .admin-sidebar{width:64px}

          .sidebar-logo{
            display:flex;align-items:center;gap:10px;
            padding:16px 14px;border-bottom:1px solid var(--border-foot);
          ...
          .logo-name{
            ...
            font-size:15px;color:var(--text-heading);white-space:nowrap;letter-spacing:-0.2px
          }
          .logo-tag{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:2.5px;color:#12c2a4}
          .collapse-btn{
            background:none;border:1px solid var(--collapse-border);
            color:var(--collapse-color);width:22px;height:22px;
            border-radius:6px;font-size:9px;display:flex;align-items:center;
            justify-content:center;flex-shrink:0;margin-left:auto;transition:all 0.2s
          }
          .collapse-btn:hover{background:var(--collapse-hover);color:var(--text-heading)}

          .admin-nav{flex:1;padding:10px 8px;display:flex;flex-direction:column;gap:2px;overflow-y:auto}
          .nav-item{
            display:flex;align-items:center;gap:10px;padding:9px 11px;
            border-radius:10px;font-size:13.5px;font-weight:500;
            color:var(--text-nav);transition:all 0.15s;white-space:nowrap;
          ...
          .nav-item.active{
            background:var(--nav-active-bg);color:#0d7a68;
            border-color:var(--nav-active-border);font-weight:600
          }
          ...
          .user-pill{
            ...
            background:var(--bg-user-pill);border-radius:10px;overflow:hidden;border:1px solid var(--border)
          }
          .avatar{
          ...
          .avatar-solo{
            ...
            background:linear-gradient(135deg,#0d7a68,#12c2a4);
            border-radius:10px;display:flex;align-items:center;
            justify-content:center;font-weight:800;font-size:13px;color:#fff;cursor:default
          }
          ...
          .logout-btn{
            ...
            border-radius:10px;border:1px solid var(--logout-border);
            background:none;color:var(--logout-color);
          ...
          .admin-main{margin-left:228px;flex:1;min-height:100vh;display:flex;flex-direction:column;transition:margin-left 0.22s ease}
          .admin-root.collapsed .admin-main{margin-left:64px}
          ...
          .admin-topbar{
            ...
            justify-content:space-between;transition:background 0.25s ease
          }
          .page-title{
            font-family:'Outfit',system-ui,sans-serif;
            font-size:19px;font-weight:800;color:var(--text-heading);letter-spacing:-0.3px
          }
          ...
          .env-badge{
            ...
            background:rgba(13,122,104,0.12);color:#0d7a68;border:1px solid rgba(13,122,104,0.25)
          }

          .theme-toggle{
            display:flex;align-items:center;gap:7px;padding:5px 10px 5px 6px;
            border-radius:20px;border:1px solid var(--theme-border);
            background:var(--theme-track-bg);transition:all 0.2s;cursor:pointer
          }
          .theme-toggle:hover{border-color:rgba(13,122,104,0.4);background:rgba(13,122,104,0.08)}
          .theme-track{
            width:36px;height:20px;background:rgba(0,0,0,0.1);border-radius:10px;
            position:relative;border:1px solid var(--theme-border);transition:background 0.25s;flex-shrink:0
          }
          html[data-theme="light"] .theme-track{background:rgba(13,122,104,0.2)}
          .theme-thumb{
            position:absolute;top:1px;left:1px;width:16px;height:16px;
            border-radius:50%;background:var(--theme-thumb-bg);
            display:flex;align-items:center;justify-content:center;font-size:10px;
            box-shadow:0 1px 4px rgba(0,0,0,0.25);
            transition:transform 0.25s cubic-bezier(.4,0,.2,1)
          }
          html[data-theme="light"] .theme-thumb{transform:translateX(16px)}
          .theme-label{font-size:11.5px;font-weight:700;color:var(--theme-label-color);letter-spacing:0.3px;user-select:none}

          .site-link{
            font-size:12.5px;font-weight:600;color:var(--text-site-lnk);
            border:1px solid var(--border);padding:6px 13px;border-radius:8px;transition:all 0.2s
          }
          ...
          html[data-theme="light"] .bg-green{background:rgba(34,197,94,0.15);color:#15803d}
          .bg-red{background:rgba(239,68,68,0.12);color:#dc2626}
          html[data-theme="light"] .bg-red{background:rgba(239,68,68,0.12);color:#b91c1c}
