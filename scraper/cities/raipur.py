"""
GovPlot Tracker — NRDA Raipur Scraper
Rank: 11 | Authority: Nava Raipur Atal Nagar Development Authority
...
class NRDAScraper(CityScraperMixin, BaseScraper):
    CITY = "Raipur"
    AUTH = "NRDA"
    BASE_URL = "https://www.nava-raipur.com"
    TIER1_URLS = [
        "https://www.nava-raipur.com",
        "https://www.nava-raipur.com/scheme",
        "https://www.nava-raipur.com/residential-plot",
    ]
    AGGREGATOR_URLS = [
        "https://www.eauctionsindia.com/blog-details/raipur",
        "https://awaszone.com/raipur/",
    ]
    ...
    def _parse(self, soup, source_url: str) -> list[SchemeData]:
        ...
        for el in candidates:
            ...
            schemes.append(make_scheme(
                ...
                location_details="Nava Raipur Atal Nagar Smart City",
            ))
        return schemes
    ...
    def scrape_aggregators(self) -> list[SchemeData]:
        ...
        for url in self.AGGREGATOR_URLS:
            ...
            parsed = self._parse_aggregator_generic(
                soup, url, self.AUTH, self.CITY, self.BASE_URL, "Nava Raipur Atal Nagar Smart City"
            )
