"""
GovPlot Tracker — NIT Nagpur Scraper
Rank: 14 | Authority: Nagpur Improvement Trust
...
class NITScraper(CityScraperMixin, BaseScraper):
    CITY = "Nagpur"
    AUTH = "NIT"
    BASE_URL = "https://nagpurimprovement.gov.in"
    TIER1_URLS = [
        "https://nagpurimprovement.gov.in",
        "https://nagpurimprovement.gov.in/scheme",
        "https://nagpurimprovement.gov.in/residential-plot",
    ]
    AGGREGATOR_URLS = [
        "https://www.eauctionsindia.com/blog-details/nagpur",
        "https://awaszone.com/nagpur/",
    ]
    ...
    def _parse(self, soup, source_url: str) -> list[SchemeData]:
        ...
        for el in candidates:
            ...
            schemes.append(make_scheme(
                ...
                location_details="Nagpur Improvement Trust zone",
            ))
        return schemes
    ...
    def scrape_aggregators(self) -> list[SchemeData]:
        ...
        for url in self.AGGREGATOR_URLS:
            ...
            parsed = self._parse_aggregator_generic(
                soup, url, self.AUTH, self.CITY, self.BASE_URL, "Nagpur Improvement Trust zone"
            )
