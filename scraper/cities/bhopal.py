"""
GovPlot Tracker — VP-BPL Bhopal Scraper
Rank: 16 | Authority: Vikas Pradhikaran Bhopal
...
class VPBPLScraper(CityScraperMixin, BaseScraper):
    CITY = "Bhopal"
    AUTH = "VP-BPL"
    BASE_URL = "https://vikaspradhikaran.mponline.gov.in"
    TIER1_URLS = [
        "https://vikaspradhikaran.mponline.gov.in",
        "https://vikaspradhikaran.mponline.gov.in/scheme",
        "https://vikaspradhikaran.mponline.gov.in/residential-plot",
    ]
    AGGREGATOR_URLS = [
        "https://www.eauctionsindia.com/blog-details/bhopal",
        "https://awaszone.com/bhopal/",
    ]
    ...
    def _parse(self, soup, source_url: str) -> list[SchemeData]:
        ...
        for el in candidates:
            ...
            schemes.append(make_scheme(
                ...
                location_details="Bhopal Development Authority zone",
            ))
        return schemes
    ...
    def scrape_aggregators(self) -> list[SchemeData]:
        ...
        for url in self.AGGREGATOR_URLS:
            ...
            parsed = self._parse_aggregator_generic(
                soup, url, self.AUTH, self.CITY, self.BASE_URL, "Bhopal Development Authority zone"
            )
