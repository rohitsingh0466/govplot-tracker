"""
GovPlot Tracker — MDDA Dehradun Scraper
Rank: 18 | Authority: Mussoorie Dehradun Development Authority
...
class MDDAScraper(CityScraperMixin, BaseScraper):
    CITY = "Dehradun"
    AUTH = "MDDA"
    BASE_URL = "http://mddaonline.in"
    TIER1_URLS = [
        "http://mddaonline.in",
        "http://mddaonline.in/scheme",
        "http://mddaonline.in/residential-plot",
    ]
    AGGREGATOR_URLS = [
        "https://www.eauctionsindia.com/blog-details/dehradun",
    ...
    def _parse(self, soup, source_url: str) -> list[SchemeData]:
        ...
        for el in candidates:
            ...
            schemes.append(make_scheme(
                ...
                location_details="Mussoorie Dehradun Development Authority zone",
            ))
        return schemes
    ...
    def scrape_aggregators(self) -> list[SchemeData]:
        ...
        for url in self.AGGREGATOR_URLS:
            ...
            parsed = self._parse_aggregator_generic(
                soup, url, self.AUTH, self.CITY, self.BASE_URL, "Mussoorie Dehradun Development Authority zone"
            )
