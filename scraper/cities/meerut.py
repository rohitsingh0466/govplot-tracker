"""
GovPlot Tracker — MDA Meerut Scraper
Rank: 19 | Authority: Meerut Development Authority
...
class MDAScraper(CityScraperMixin, BaseScraper):
    CITY = "Meerut"
    AUTH = "MDA"
    BASE_URL = "https://mda.up.gov.in"
    TIER1_URLS = [
        "https://mda.up.gov.in",
        "https://mda.up.gov.in/scheme",
        "https://mda.up.gov.in/residential-plot",
    ]
    AGGREGATOR_URLS = [
        "https://www.eauctionsindia.com/blog-details/meerut",
        "https://awaszone.com/meerut/",
    ]
    ...
    def _parse(self, soup, source_url: str) -> list[SchemeData]:
        ...
        for el in candidates:
            ...
            schemes.append(make_scheme(
                ...
                location_details="Meerut NCR RRTS corridor zone",
            ))
        return schemes
    ...
    def scrape_aggregators(self) -> list[SchemeData]:
        ...
        for url in self.AGGREGATOR_URLS:
            ...
            parsed = self._parse_aggregator_generic(
                soup, url, self.AUTH, self.CITY, self.BASE_URL, "Meerut NCR RRTS corridor zone"
            )
