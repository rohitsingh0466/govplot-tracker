"""
GovPlot Tracker — VDA Varanasi Scraper
Rank: 12 | Authority: Varanasi Development Authority
...
class VDAScraper(CityScraperMixin, BaseScraper):
    CITY = "Varanasi"
    AUTH = "VDA"
    BASE_URL = "https://vdavns.com"
    TIER1_URLS = [
        "https://vdavns.com",
        "https://vdavns.com/scheme",
        "https://vdavns.com/residential-plot",
    ]
    AGGREGATOR_URLS = [
        "https://www.eauctionsindia.com/blog-details/varanasi",
        "https://awaszone.com/varanasi/",
    ]
    ...
    def _parse(self, soup, source_url: str) -> list[SchemeData]:
        ...
        for el in candidates:
            ...
            schemes.append(make_scheme(
                ...
                location_details="Varanasi Development Authority zone",
            ))
        return schemes
    ...
    def scrape_aggregators(self) -> list[SchemeData]:
        ...
        for url in self.AGGREGATOR_URLS:
            ...
            parsed = self._parse_aggregator_generic(
                soup, url, self.AUTH, self.CITY, self.BASE_URL, "Varanasi Development Authority zone"
            )
