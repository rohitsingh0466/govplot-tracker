"""
GovPlot Tracker — BDA-OD Bhubaneswar Scraper
Rank: 13 | Authority: Bhubaneswar Development Authority
...
class BDAODScraper(CityScraperMixin, BaseScraper):
    CITY = "Bhubaneswar"
    AUTH = "BDA-OD"
    BASE_URL = "https://www.bda.gov.in"
    TIER1_URLS = [
        "https://www.bda.gov.in",
        "https://www.bda.gov.in/scheme",
        "https://www.bda.gov.in/residential-plot",
    ]
    AGGREGATOR_URLS = [
        "https://www.eauctionsindia.com/blog-details/bhubaneswar",
        "https://awaszone.com/bhubaneswar/",
    ]
    ...
    def _parse(self, soup, source_url: str) -> list[SchemeData]:
        ...
        for el in candidates:
            ...
            schemes.append(make_scheme(
                ...
                location_details="Bhubaneswar Development Authority zone",
            ))
        return schemes
    ...
    def scrape_aggregators(self) -> list[SchemeData]:
        ...
        for url in self.AGGREGATOR_URLS:
            ...
            parsed = self._parse_aggregator_generic(
                soup, url, self.AUTH, self.CITY, self.BASE_URL, "Bhubaneswar Development Authority zone"
            )
